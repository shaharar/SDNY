...
/*    private static void test6(DBManager dBmanager) {
    ...
    private static void test3(DBManager dBmanager) {
        VacationObject vacationObject=new VacationObject(2,"a","new",true,"ADULT7BABY1",true,"EL-AL","Tel-Aviv","Paris","1112201813122018",3,27);
        dBmanager.InsertVacation(vacationObject); //changed to hot vacation
        VacationObject vacationObject2=new VacationObject(3,"a","new",true,"ADULT7BABY1",true,"EL-AL","Eilat","Tel-Aviv","1112201813122018",3,1);
    ...
    private static void test2point2(DBManager dBmanager) {
        VacationObject vacationObject=new VacationObject(1,"a","new",true,"ADULT7BABY1",true,"EL-AL","Tel-Aviv","Paris","1112201813122018",3,27);
        dBmanager.UpdateVacation(vacationObject); //changed nothing

    }
    private static void test2point1(DBManager dBmanager) {
        VacationObject vacationObject=new VacationObject(2,"a","new",true,"ADULT7BABY1",true,"EL-AL","Eilat", "Tel-Aviv","1112201813122018",3,27);
    ...
    private static void test2(DBManager dBmanager) {
        ...
        VacationObject vacationObject2=new VacationObject(1,"a","new",true,"ADULT7BABY1",true,"EL-AL","Eilat","Tel-Aviv","1112201813122018",3,1);
